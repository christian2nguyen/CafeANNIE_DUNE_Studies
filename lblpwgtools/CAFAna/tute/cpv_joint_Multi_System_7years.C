...
std::string outputFname =  stateFname + "Feb10_OUTPUT_"+ paraset_name + "_624ktmwyr_" + sampleString + "_" + systSet  + "_" + penaltyString +"_asimov_set_" + asimov_set +  "NoSplitCrosssection_.root";
 std::cout<<"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"<< std::endl;
...
void cpv_joint_Multi_System_7years(){
