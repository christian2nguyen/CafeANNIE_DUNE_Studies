...
void PrintNuFitValues() {

    std::cout << std::left << std::setw(22) << "kNuFitTh23LoNH" 
              << std::right << kNuFitTh23LoNH << "\n";

    std::cout << std::left << std::setw(22) << "kNuFitTh23HiNH" 
              << std::right << kNuFitTh23HiNH << "\n";

    std::cout << std::left << std::setw(22) << "kNuFitTh23LoIH" 
              << std::right << kNuFitTh23LoIH << "\n";

    std::cout << std::left << std::setw(22) << "kNuFitTh23HiIH" 
              << std::right << kNuFitTh23HiIH << "\n";

    std::cout << std::left << std::setw(22) << "kNuFitTh23MinNH" 
              << std::right << kNuFitTh23MinNH << "\n";

    std::cout << std::left << std::setw(22) << "kNuFitTh23MinIH" 
              << std::right << kNuFitTh23MinIH << "\n";

    std::cout << std::left << std::setw(22) << "kNuFitTh23MaxNH" 
              << std::right << kNuFitTh23MaxNH << "\n";

    std::cout << std::left << std::setw(22) << "kNuFitTh23MaxIH" 
              << std::right << kNuFitTh23MaxIH << "\n";

    std::cout << std::left << std::setw(22) << "kNuFitTh13MinNH" 
              << std::right << kNuFitTh13MinNH << "\n";

    std::cout << std::left << std::setw(22) << "kNuFitTh13MinIH" 
              << std::right << kNuFitTh13MinIH << "\n";

    std::cout << std::left << std::setw(22) << "kNuFitTh13MaxNH" 
              << std::right << kNuFitTh13MaxNH << "\n";

    std::cout << std::left << std::setw(22) << "kNuFitTh13MaxIH" 
              << std::right << kNuFitTh13MaxIH << "\n";

    std::cout << std::left << std::setw(22) << "kNuFitDmsq32MinNH" 
              << std::right << kNuFitDmsq32MinNH << "\n";

    std::cout << std::left << std::setw(22) << "kNuFitDmsq32MinIH" 
              << std::right << kNuFitDmsq32MinIH << "\n";

    std::cout << std::left << std::setw(22) << "kNuFitDmsq32MaxNH" 
              << std::right << kNuFitDmsq32MaxNH << "\n";

    std::cout << std::left << std::setw(22) << "kNuFitDmsq32MaxIH" 
              << std::right << kNuFitDmsq32MaxIH << "\n";
}
...
void Asimov_sets_review(){

std::string asimov_str; 

for(int asimov_int = 0; asimov_int < 9; asimov_int++ ){
asimov_str = std::to_string(asimov_int);

std::cout<<"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"<<std::endl;
osc::IOscCalculatorAdjustable* testOsc = NuFitOscCalc(1, 1, asimov_str);
osc::IOscCalculatorAdjustable* testOscI = NuFitOscCalc(1, 1, asimov_int);

    std::cout << "  L      : " << testOsc->GetL()      << " vs " << testOscI->GetL()      << "\n";
    std::cout << "  Rho    : " << testOsc->GetRho()    << " vs " << testOscI->GetRho()    << "\n";
    std::cout << "  Dmsq21 : " << testOsc->GetDmsq21() << " vs " << testOscI->GetDmsq21() << "\n";
    std::cout << "  Dmsq32 : " << testOsc->GetDmsq32() << " vs " << testOscI->GetDmsq32() << "\n";
    std::cout << "  Th12   : " << testOsc->GetTh12()   << " vs " << testOscI->GetTh12()   << "\n";
    std::cout << "  Th13   : " << testOsc->GetTh13()   << " vs " << testOscI->GetTh13()   << "\n";
    std::cout << "  Th23   : " << testOsc->GetTh23()   << " vs " << testOscI->GetTh23()   << "\n";
    std::cout << "  dCP    : " << testOsc->GetdCP()    << " vs " << testOscI->GetdCP() << "\n";
...
void cpv_joint_Multi_noSystem_printpars(){
